    ...
    return (
      <div>
        ...
        >
          <Grid item>
            <Typography
              sx={{ fontWeight: 10000, fontSize: 50, marginBottom: 5 }}
              color="#ffffff"
            >
              Profile Details
            </Typography>
          ...
          <Grid item>
            <Typography> Student First Name: </Typography>{" "}
            <div> {student.firstName}</div>
          </Grid>
          <Grid item>
            <Typography> Student Last Name: </Typography>{" "}
