          ...
          >
            <AppBar>
              ...
              >
                ...
                >
                  <Button
                    onClick={() => {
                      this.toSearchCourses(this.state.student.email);
                    }}
                    sx={{
                  ...
                  <Button
                    onClick={() => {
                      this.toPlanofstudy(this.state.student.email);
                    }}
                    sx={{
                      backgroundColor: "#ffffff",
                      fontWeight: 700,
            ...
            <Box component="main">
              ...
              >
                ...
                <Select
                  label="Please Select a Sorting Category"
                  onChange={(e) =>
                    this.getSuggestedSemester(id, e.target.value)
                  }
                >
                  <MenuItem key="rating" value="rating">
                    Rating
                  </MenuItem>
                  <MenuItem key="avgGPA" value="avgGPA">
                    Average GPA
                  </MenuItem>
                </Select>
                  ...
                  {coursesSuggested &&
                    coursesSuggested.map((course, index) => (
                      <li
                        ...
                        onClick={() => {
                          this.toCoursepage(student.email, course.courseID);
                        }}
                        key={index}
                      >
